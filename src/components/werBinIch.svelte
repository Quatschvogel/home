...
{#if a >= 1}
<div class="py-12 sm:py-16 xl:py-20 xl:px-10 xl:w-5/6 px-4 w-11/12 rounded-lg bg-gray-200 mx-auto mt-8 flex" in:fly="{{y: -100, duration: 1000}}">	
	...
	<div class="bg-transparent text-left rounded-lg border-gray-900 border-2">
